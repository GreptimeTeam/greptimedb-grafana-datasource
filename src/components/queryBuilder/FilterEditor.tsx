...
const filterOperators: Array<SelectableValue<FilterOperator>> = [
  ...
  { value: FilterOperator.MatchesTerm, label: '@@ (matches_term)' },
  { value: FilterOperator.NotMatchesTerm, label: 'NOT @@ (NOT matches_term)' },
  { value: FilterOperator.MatchesTermCaseInsensitive, label: '@@ (matches_term, case-insensitive)' },
  { value: FilterOperator.NotMatchesTermCaseInsensitive, label: 'NOT @@ (matches_term, case-insensitive)' },
